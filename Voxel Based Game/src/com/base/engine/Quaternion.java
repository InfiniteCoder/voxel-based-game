...
public class Quaternion {
	...
	/*public Matrix4f toRotationMatrix() {
		Vector3f forward = new Vector3f(2.0f * (x * z - w * y),
				2.0f * (y * z + w * x), 1.0f - 2.0f * (x * x + y * y));
		Vector3f up = new Vector3f(2.0f * (x * y + w * z),
				1.0f - 2.0f * (x * x + z * z), 2.0f * (y * z - w * x));
		Vector3f right = new Vector3f(1.0f - 2.0f * (y * y + z * z), 2.0f * (x
				* y - w * z), 2.0f * (x * z + w * y));
	...
	public Quaternion nlerp(Quaternion dest, float lerpFactor, boolean shortest) {
		...
		if (shortest && this.dot(dest) < 0)
			correctedDest = new Quaternion(-dest.getX(), -dest.getY(),
					-dest.getZ(), -dest.getW());
	...
	public Quaternion slerp(Quaternion dest, float lerpFactor, boolean shortest) {
		...
		float srcFactor = (float) Math.sin((1.0f - lerpFactor) * angle)
				* invSin;
